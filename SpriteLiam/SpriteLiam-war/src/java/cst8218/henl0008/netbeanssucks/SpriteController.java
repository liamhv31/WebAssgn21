/**
 * This class is responsible handling all of the requests that are being made by
 * the user and performs actions as necessary
 * 
 * @author Liam Henley-Vachon
 * @version 1
 * @since 11/22/2020
 */
package cst8218.henl0008.netbeanssucks;

import cst8218.henl0008.entity.Sprite;
import cst8218.henl0008.netbeanssucks.util.JsfUtil;
import cst8218.henl0008.netbeanssucks.util.PaginationHelper;
...
public class SpriteController implements Serializable {
    ...
    @EJB
    private cst8218.henl0008.entity.SpriteFacade ejbFacade;
    ...
    private cst8218.henl0008.entity.SpriteFacade getFacade() {
        return ejbFacade;
    }
